...
export class DiagramRenderer {
    ...
    private getParentElement(element: DiagramElement, defaultParent: HTMLCanvasElement | SVGElement, svgElement: SVGSVGElement):
        SvgParent {
        ...
        if (svgElement && this.diagramId && element && element.id) {
            ...
            let groupElement: SvgParent = this.getGroupElement(element, defaultParent || layerGElement);
    ...
    private getGroupElement(element: DiagramElement, canvas: HTMLCanvasElement | SVGElement): SvgParent {
